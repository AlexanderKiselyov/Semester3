...
namespace GraphicEditor
{
	partial class GraphicEditor
	{
		...
		private void InitializeComponent()
		{
			...
			ReturnButton.Click += new System.EventHandler(ReturnButton_Click);
			// 
			// CancellationButton
			// 
			...
			CancellationButton.Click += new System.EventHandler(CancellationButton_Click);
			// 
			// DeleteButton
			// 
			...
			RelocateButton.Click += new System.EventHandler(RelocateButton_Click);
			// 
			// Picture
			// 
			...
			this.Picture.MouseClick += new MouseEventHandler(this.Mouse_Click);
			this.Picture.MouseMove += new MouseEventHandler(this.MoveMouse);
			// 
			// GraphicEditor
			// 
